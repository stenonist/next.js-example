...
const Home = () => {
	return (
		<section className="w-full">
			...
			>
				<Image
					className="absolute top-0 bottom-0 right-0 w-3/4 h-full"
			...
			<div className="relative" id="adLanding">
				<Image
				...
				<div className="flex flex-col items-end justify-center w-1/2 ml-auto gap-36 py-28 mainCont">
					<p className="text-3xl text-right drop-shadow-lg">
						We got bored of constantly seeing ads and sponsored
						posts all over our Social Feed.
					</p>
					<p className="text-3xl text-right drop-shadow-lg">
